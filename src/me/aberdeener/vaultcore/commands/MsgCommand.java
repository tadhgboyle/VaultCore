		...
		if (commandLabel.equalsIgnoreCase("msg")) {
			...
			if (!sender.hasPermission("vc.msg")) {
				...
				if (target == sender) {
					...
					String meTo = (ChatColor.GOLD + sender.getName() + ChatColor.YELLOW + " -> "
							+ ChatColor.GOLD + target.getName() + ChatColor.YELLOW + ":");
					String toMe = (ChatColor.GOLD + player.getName()
							+ ChatColor.YELLOW + " -> " + ChatColor.GOLD + target.getName() + ChatColor.YELLOW + ":");
