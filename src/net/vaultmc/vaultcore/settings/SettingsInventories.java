...
public class SettingsInventories {
	...
	public static Inventory settingsMain() {
		...
		inv.setItem(11, new ItemStackBuilder(Material.ENDER_PEARL)
				.name(variable1 + "Teleportation " + string + "settings...").build());
		inv.setItem(13, new ItemStackBuilder(Material.GRASS_BLOCK)
				.name(variable1 + "Creative " + string + "settings...").build());
		inv.setItem(15,
				new ItemStackBuilder(Material.PAPER).name(variable1 + "Chat " + string + "settings...").build());
	...
	public static Inventory teleportationSettings() {
		...
		inv.setItem(31, new ItemStackBuilder(Material.BOOK).name(string + "Back...").build());
	...
	public static void init(VLPlayer player) {
		...
		toggleSwearLore.add(string + "Enabled: " + variable2 + player.getDataConfig().get("settings.swearfilter"));
