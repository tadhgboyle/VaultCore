...
import net.vaultmc.vaultcore.staff.punishments.ban.BanCommand;
import net.vaultmc.vaultcore.staff.punishments.ban.BannedListener;
import net.vaultmc.vaultcore.staff.punishments.ban.IpBanCommand;
import net.vaultmc.vaultcore.staff.punishments.ban.IpTempBanCommand;
import net.vaultmc.vaultcore.staff.punishments.ban.TempBanCommand;
import net.vaultmc.vaultcore.staff.punishments.ban.UnbanCommand;
import net.vaultmc.vaultcore.staff.punishments.kick.KickCommand;
import net.vaultmc.vaultcore.staff.punishments.mute.IpMuteCommand;
import net.vaultmc.vaultcore.staff.punishments.mute.IpTempMuteCommand;
import net.vaultmc.vaultcore.staff.punishments.mute.MuteCommand;
import net.vaultmc.vaultcore.staff.punishments.mute.MutedListener;
import net.vaultmc.vaultcore.staff.punishments.mute.TempMuteCommand;
import net.vaultmc.vaultcore.staff.punishments.mute.UnmuteCommand;
