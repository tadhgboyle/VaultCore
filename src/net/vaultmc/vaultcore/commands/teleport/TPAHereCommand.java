...
public class TPAHereCommand extends CommandExecutor {
    ...
    public void tpaHere(VLPlayer player, VLPlayer target) {
        ...
        player.sendMessage(string + "You requested that " + target.getFormattedName() + string
                + " teleports to you.");
        target.sendMessage(player.getFormattedName() + string + " asked you to teleport to them, type "
