...
public class HelpCommand extends CommandExecutor {
    ...
    public HelpCommand() {
        ...
        this.register("generalHelp", Arrays.asList(
                Commands.literal("general")),
                "VaultCore");
        this.register("creativeHelp", Arrays.asList(
                Commands.literal("creative")),
                "VaultCore");
        this.register("survivalHelp", Arrays.asList(
                Commands.literal("survival")),
                "VaultCore");
        this.register("clansHelp", Arrays.asList(
                Commands.literal("clans")),
                "VaultCore");
        this.register("skyblockHelp", Arrays.asList(
